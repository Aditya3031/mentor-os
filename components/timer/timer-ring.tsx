...
const mode = useStore((s) => s.mode);
  ...
  return (
    <div className="relative grid aspect-square w-[min(420px,70vw)] place-items-center">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center gap-1.5">
        <div className="text-[clamp(64px,9vw,96px)] font-extralight leading-none tracking-tight tabular-nums">
